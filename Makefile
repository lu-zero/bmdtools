...
CXX=g++
SDK_PATH=../../include
CFLAGS=-framework CoreFoundation -Wno-multichar -I $(SDK_PATH) -fno-rtti -D__STDC_CONSTANT_MACROS -g
LDFLAGS=-framework CoreFoundation -lm -ldl -lpthread `pkg-config --libs libavformat libswscale`
